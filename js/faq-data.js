const faqData = [
    ...
    },
    {
        ...
        answer: "Untuk jangka pendek, harga emas sentiasa ada turun naik. <strong>Tetapi dalam jangka panjang, harga emas sentiasa naik.</strong><br><br>Ini disebabkan nilai duit kertas sentiasa menyusut dalam jangka panjang disebabkan inflasi dan kejatuhan nilai ringgit.<br><br>Sejarah 20 tahun menunjukkan <strong>harga emas naik secara purata sekitar 10% setahun</strong>.<br><br><strong>Harga emas akan terus naik dalam jangka panjang selagi mana sistem wang kertas (wang fiat) digunakan.</strong> Selagi kerajaan terus mencetak wang (yang menyebabkan nilainya semakin menurun), selagi itulah harga emas akan terus naik.<br><br>Kalau harga barangan keperluan harian pun confirm akan naik dalam jangka panjang (disebabkan nilai duit semakin menurun), inikan pula emas, hartanah dan aset-aset fizikal yang lain."
    },
    {
        id: "faq-6",
        category: "asas-simpanan",
    ...
    },
    {
        ...
        answer: "Letakkan target sekurang-kurangnya <strong>100 gram emas untuk satu keluarga</strong>. Bila sudah capai 100 gram pertama, target seterusnya ialah memiliki <strong>1 kilogram emas untuk satu keluarga</strong>. Mulakan tabiat simpan <strong>1 gram 1 bulan</strong> dulu.<br><br>Menurut pakar kewangan Tuan Azizi Ali, setiap kita patut simpan <strong>sekurang-kurangnya 10% daripada jumlah kekayaan (nett worth)</strong> kita dalam bentuk emas sebagai benteng terakhir kekayaan kita.<br><br>Ini disebabkan nilainya terjamin dan tidak terjejas walauapapun keadaan ekonomi ataupun politik sesebuah negara.<br><br>Jadikan emas sebagai benteng terakhir kewangan keluarga. Tidak ada siapa tahu berapa banyak simpanan emas yang kita ada, dan simpanan emas kita itu tidak boleh dibekukan oleh kerajaan sebagaimana aset-aset yang lain (jika jatuh muflis atau nama disenarai-hitamkan)."
    },
    {
        id: "faq-11",
        category: "asas-simpanan",
        question: "Apakah perkara penting yang perlu tahu untuk elakkan kerugian dalam pelaburan emas?",
        answer: "1. Simpanan <strong>emas tiada pendapatan</strong> bulanan atau tahunan macam dividen ASB/Tabung Haji. Yang ada cuma, beli harga rendah dan jual harga tinggi untuk dapat keuntungan. Mana-mana pelaburan emas yang menjanjikan pendapatan, itu semua scam.<br><br>2. <strong>Beli emas mesti dapat emas (fizikal)</strong>, sama macam beli emas di kedai-kedai emas. Emas itu kita boleh simpannya sendiri, tanpa ada syarat mesti simpan dengan mana-mana syarikat untuk tempoh tertentu.<br><br>3. Emas sesuai untuk simpanan jangka panjang, <strong>sekurang-kurangnya 2 tahun ke atas</strong>. Emas tak sesuai dibeli dengan duit yang nak digunakan pada waktu terdekat. Sejarah 20 tahun harga emas menunjukkan <strong>harga emas naik secara purata 10% setahun</strong>.<br><br>4. Beli emas bermaksud simpan duit. <strong>Beli emas duit tak habis</strong>. Bila nak pakai duit, boleh jual atau pajak sahaja pada bila-bila masa.<br><br>5. Transaksi jual beli emas terdedah kepada risiko terkait dengan aktiviti \"gubahan wang haram\" (AMLA) yang dipantau selia oleh Bank Negara Malaysia (BNM). Untuk elakkan ditipu atau terkait dengan isu AMLA, <strong>pastikan jual beli emas hanya dengan syarikat yang sudah trusted dan berkredibiliti sahaja</strong>. Bukan dari mana-mana individu yang tidak dikenali."
    },
    {
        id: "faq-12",
        category: "asas-simpanan",
    ...
    },
    {
        ...
        answer: "Secara idealnya, penyimpan emas tegar tak jual emas mereka kecuali dalam 3 keadaan:<br><br>1. Untuk ditukarkan kepada aset yang lebih baik,<br>2. Sudah capai matlamat simpanan, atau<br>3. Ada hal kecemasan, sedangkan dana kecemasannya sudah habis.<br><br>Selain daripada 3 keadaan ini, penyimpan emas tegar akan pajak emas mereka kalau perlukan tunai segera, dan akan tebus semula secepat mungkin dalam masa 6 - 12 bulan.<br><br><strong>Sekiranya anda tak mampu tebus emas tersebut dalam masa 6 - 12 bulan, pilihan terbaik ialah jual sahaja emas tersebut.</strong>"
    },
    {
        id: "faq-22",
        category: "strategi-emas",
    ...
    },
    {
        ...
        answer: "Daftar di sini (percuma):<br><br>&bull; <a href='https://publicgold.com.my/index.php?route=account/register&intro_pgcode=PG00556711&is_dealer=1' target='_blank' rel='noopener'><strong>AKAUN DEWASA</strong></a><br>&bull; <a href='https://publicgold.com.my/index.php?route=account/register&form_type=ja&intro_pgcode=PG00556711&is_dealer=1' target='_blank' rel='noopener'><strong>AKAUN JUNIOR (bawah 18 tahun)</strong></a><br><br>Setelah berjaya daftar, download <strong>aplikasi \"Public Gold\"</strong> untuk buat pembelian cara yang lebih mudah.<br><br>&bull; <a href='https://play.google.com/store/apps/details?id=com.pgmapp.publicgold&pli=1' target='_blank' rel='noopener'>Android</a><br>&bull; <a href='https://apps.apple.com/my/app/public-gold/id1591580964' target='_blank' rel='noopener'>iOS</a><br><br>Bagi yang sudah ada \"PG Code\" (user ID Public Gold), boleh gunakan PG Code sedia ada untuk login dan buat pembelian."
    },
    {
        id: "faq-25",
        category: "transaksi-pg",
        question: "Berapa bajet paling minimum untuk memulakan simpanan emas?",
        answer: "Dengan Public Gold, boleh mula menabung emas dengan bajet serendah <strong>RM100</strong> melalui Akaun Emas GAP.<br><br>Dan boleh tambah tabungan pada bila-bila masa dengan bajet minimum RM100 setiap kali pembelian.<br><br>Tidak ada syarat wajib untuk beli setiap bulan.<br><br>Item paling kecil boleh dikeluarkan dari Akaun GAP ialah gold bar <strong>0.5 gram</strong> (berketulenan 999.9) pelbagai design."
    },
    {
        id: "faq-26",
        category: "transaksi-pg",
        question: "Bolehkah beli terus secara walk-in di branch Public Gold terdekat?",
        answer: "Public Gold <strong>tak terima belian secara walk-in</strong>.<br><br>Untuk keselesaan hampir 1 juta pelanggan, branch Public Gold hanya berikan servis untuk pelanggan yang nak collect item emas bersaiz besar (yang tidak boleh dihantar melalui GIT i.e. pos berinsurans), iaitu item 50 gram / 10 dinar (42.5 gram) ke atas.<br><br>Untuk datang collect emas, kena order, buat pembayaran, dan set appointment terlebih dahulu.<br><br>Untuk item kecil (item 5 dinar / 20 gram ke bawah), Public Gold akan pos terus dari HQ Penang menggunakan servis Gold-in-Transit (GIT).<br><br>Untuk pembelian, ikut panduan <a href='https://pg2u.my/wanhasbullah/cara-bermula' target='_blank' rel='noopener'>DI SINI</a>."
    },
    {
        id: "faq-27",
        category: "transaksi-pg",
    ...
    },
    {
        ...
        answer: "Daftar di sini (percuma):<br><br>&bull; <a href='https://publicgold.com.my/index.php?route=account/register&intro_pgcode=PG00556711&is_dealer=1' target='_blank' rel='noopener'><strong>AKAUN DEWASA</strong></a><br>&bull; <a href='https://publicgold.com.my/index.php?route=account/register&form_type=ja&intro_pgcode=PG00556711&is_dealer=1' target='_blank' rel='noopener'><strong>AKAUN JUNIOR (bawah 18 tahun)</strong></a><br><br>Setelah berjaya daftar, download <strong>aplikasi \"Public Gold\"</strong> untuk buat pembelian cara yang lebih mudah.<br><br>&bull; <a href='https://play.google.com/store/apps/details?id=com.pgmapp.publicgold&pli=1' target='_blank' rel='noopener'>Android</a><br>&bull; <a href='https://apps.apple.com/my/app/public-gold/id1591580964' target='_blank' rel='noopener'>iOS</a><br><br>Contact saya di Whatsapp jika ada sebarang persoalan dan nak join support group penyimpan emas di bawah bimbingan saya.<br><br>Bagi yang sudah ada \"PG Code\" (user ID Public Gold), boleh gunakan PG Code sedia ada untuk login dan buat pembelian."
    },
    {
        id: "faq-33",
        category: "akaun-gap",
...
// ── Category config ──────────────────────────────────────
const categories = {
    "asas-simpanan": { label: "Asas Simpanan Emas",        icon: "💰" },
    "memilih-emas":  { label: "Memilih Emas Terbaik",      icon: "🏅" },
    "strategi-emas": { label: "Strategi Jual, Beli & Pajak", icon: "📈" },
    "transaksi-pg":  { label: "Transaksi Emas Public Gold", icon: "🔄" },
    "akaun-gap":     { label: "Akaun Emas GAP",            icon: "🏦" },
    "bisnes-emas":   { label: "Bisnes Emas Public Gold",   icon: "🤝" }
};
